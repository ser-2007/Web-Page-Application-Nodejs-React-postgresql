...
resource "null_resource" "config" {
  ...
  connection {
    ...
    type = "ssh"
    user = "ec2-user"
    private_key = file("C:/Users/serkan/Desktop/ec2_key.pem") #use your own key and path
  }
  ...
  provisioner "file" {
    source = "C:/Users/serkan/Desktop/ec2_key.pem"
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "chmod 400 ec2_key.pem" #your own key
    ]
  }
